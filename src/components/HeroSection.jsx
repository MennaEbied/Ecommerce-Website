...
import HeroLights from "./lights/HeroLights";
    ...
    >
      <div className="rounded-2xl bg-gray-200 dark:bg-gray-800 w-full max-w-6xl relative overflow-hidden">
        <div className="flex flex-col md:flex-row justify-between items-center p-8 md:p-12 lg:p-16">
          ...
          <div
            ref={textContentRef}
            className="z-10 text-center md:text-left md:w-1/2 w-full"
          >
            ...
            <h2 className="text-5xl sm:text-6xl lg:text-8xl font-extrabold text-white dark:text-gray-700 mt-2 sm:mt-0 sm:mx-5 tracking-tighter">
              HEADPHONE
            </h2>
          ...
          <div className="relative md:w-1/2 mt-8 md:mt-0 w-full h-[400px] sm:h-[500px] z-20">
            <HeroLights />
          </div>
        </div>
      </div>
